            ...
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <motion.li 
                  ...
                  className="p-10 rounded-3xl border border-neutral-200 shadow-lg shadow-black/5 max-w-xs w-full bg-white transition-all duration-300 group" 
                >
                  <blockquote className="m-0 p-0">
                    ...
                    <footer className="flex items-center gap-3 mt-6">
                      <img
                        ...
                        src={image}
                        alt={`Avatar of ${name}`}
                        className="h-10 w-10 rounded-full object-cover ring-2 ring-neutral-100 group-hover:ring-black/10 transition-all duration-300 ease-in-out"
                      />
